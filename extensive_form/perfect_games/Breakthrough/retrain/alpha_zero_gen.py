...
flags.DEFINE_string("path", "/home/zck7060/breakthrough/retrain/retrain_data/", "Where to save checkpoints.")
...
def main(unused_argv):
  ...
  config = ppo_gmax.Config(
      ...
      output_size=None,
      az_path='baseline/models/checkpoint--1',
      n_epochs=10,
      test_masknet=FLAGS.test_masknet,
      quiet=FLAGS.quiet,
  )

  generate_retrain_data.generate_retrain_data(config)
