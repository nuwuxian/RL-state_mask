...
from open_spiel.python.algorithms import ppo_againstmcts
...
flags.DEFINE_string("path", "/home/zxc5262/models_againstmcts/", "Where to save checkpoints.")
...
def main(unused_argv):
  ...
  if FLAGS.is_training:
    ppo_againstmcts.alpha_zero(config)
  else:
    ppo_againstmcts.alpha_zero_test(config)
