...
parser.add_argument("--vic_agt_id", type=int, default=0)

# adversarial agent path
parser.add_argument("--adv_path", type=str, default='/data/jiahao/mujoco/retrain_runner/adv-agent/ucb/you/model.npy')
parser.add_argument("--adv_ismlp", type=bool, default=True)
# adversarial agent's observation norm mean / variance path
parser.add_argument("--adv_obs_normpath", type=str, default='/data/jiahao/mujoco/retrain_runner/adv-agent/ucb/you/obs_rms.pkl')
