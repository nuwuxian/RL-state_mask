...
from agent import make_adv_agent
...
class FeedForwardPolicy(ActorCriticPolicy):
    ...
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=False, layers=None, net_arch=None,
        ...
        # self.policy_net = self._load_policy_net(ob_space, ac_space, n_env, adv_agent_path, adv_ismlp, adv_obs_normpath)
    ...
    # def _load_policy_net(self, ob_space, ac_space, n_env, adv_agent_path, adv_ismlp, adv_obs_normpath):
    #     return make_adv_agent(ob_space, ac_space, n_env, adv_agent_path, adv_ismlp, adv_obs_normpath)
