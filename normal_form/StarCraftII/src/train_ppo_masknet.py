...
flags.DEFINE_string("save_dir", "/data/jiahao/TencentSC2/StarCraftII/mask_agent", "Dir to save models to")
flags.DEFINE_string("mask_path", None, "continue training")
...
flags.DEFINE_string("model_path", "/data/jiahao/TencentSC2/StarCraftII/normal-agent/checkpoint-400000", "model used to train the masknet")
