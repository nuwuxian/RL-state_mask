...
# flags.DEFINE_string("difficulties", '1,2', "Bot's strengths.")
...
flags.DEFINE_string("model_path", "/data/jiahao/TencentSC2/StarCraftII/normal-agent/checkpoint-400000", "Model path.")
