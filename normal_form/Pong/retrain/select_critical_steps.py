...
for i_episode in range(5000):
    mask_probs_path = "./recording/values_" + str(i_episode) + ".out"
...
np.savetxt("./recording/valuemax/critical_steps_starts.out", critical_steps_starts)
np.savetxt("./recording/valuemax/critical_steps_ends.out", critical_steps_ends)
