...
from open_spiel.python.algorithms import ppo_gmax
...
flags.DEFINE_string("path", "/home/zxc5262/models_gmax/", "Where to save checkpoints.")
...
def main(unused_argv):
  ...
  if FLAGS.is_training:
    ...
    ppo_gmax.alpha_zero_test(config)
